...
// turni demo (il primo è oggi)
const turniDemo = [
  {
    data: "2025-11-28", // oggi
...
function setupNavigazioneSezioni() {
  ...
  // salvo il display originale delle dashboard (per non rompere il layout)
  ...
  function mostraSezione(id) {
    ...
    // mostro solo la sezione richiesta
    sezioni.forEach((sec) => {
  ...
  // click sulle card che hanno data-section (mobile + pc)
...
function renderAssenti() {
  ...
  // prendo solo le assenze approvate
  ...
  // ordino i prossimi per data di inizio
  nextList.sort((a, b) => parseISO(a.dal) - parseISO(b.dal));

  // Sezione "Assenti oggi"
  ...
  // Sezione "Assenze prossimi giorni"
